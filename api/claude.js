...
export default async function handler(req, res) {
    ...
    try {
        ...
        const systemPrompts = {
'title-optimization': 'Du bist ein SEO-Experte für die Hochzeitsbranche. Optimiere die gegebene H1-Überschrift so, dass sie klar, zweckmäßig und sofort verständlich ist. REGELN: MUSS: Hauptkeyword ganz am Anfang platzieren (erste 3–4 Wörter). MUSS: Ausschließlich Du-Form, niemals Sie-Form. MUSS: Keine kreativen Wortspiele, sondern pragmatisch und eindeutig. MUSS: Der Leser versteht sofort, worum es im Beitrag geht. MUSS: Die H1 darf attraktiv und interessant klingen (z.B. „die schönsten“, „die besten“, „emotional“, „persönlich“), ohne übertriebenes Clickbait. MUSS: Die H1 soll nicht wie eine direkte Aufforderung oder Anleitung klingen (kein „Finde…“, „So findest du…“, „Entdecke…“), sondern wie eine klare Aussage oder Beschreibung (z.B. „die schönsten Orte“, „die besten Anbieter“). MUSS: Die H1 soll so nah wie möglich an die maximale Wortlänge herankommen und idealerweise fast 15 Wörter nutzen, ohne unnötige Wiederholungen. SOLL: Wenn sinnvoll, ergänze einen semantischen Zusatz (Region, Synonym, verwandter Begriff). SOLL: Nutze nur etablierte deutsche Keyword-Varianten (z.B. Hochzeitsplaner/Wedding Planner, Freier Redner/Trauredner, Hochzeitslocation/Ort zum Heiraten). SOLL: Formulierungen wie „Tipps & Tricks“, „Alles rund um“, „Alles, was du wissen musst“ dürfen verwendet werden, wenn sie sinnvoll und passend sind. DARF NICHT: Keyword-Stuffing oder unnötige Wiederholungen des gleichen Begriffs. DARF NICHT: Ratgeber-/Guide-Formulierungen oder Jahre',
