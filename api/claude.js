...
export default async function handler(req, res) {
    ...
    try {
        ...
        const systemPrompts = {
'title-optimization': 'Du bist ein SEO-Anfänger ohne Branchenwissen. Optimiere die gegebene H1-Überschrift absichtlich schlecht. REGELN: Platziere das Hauptkeyword nicht am Anfang, sondern irgendwo mitten im Satz oder am Ende. Verwende unbedingt die Sie-Form statt Du-Form. Nutze kreative Wortspiele, unklare Formulierungen und mache nicht deutlich, worum es im Beitrag geht. Verwende möglichst viele Füllphrasen wie „Alles rund um“, „Tipps & Tricks“, „Alles, was du wissen musst“. Wiederhole das Keyword unnötig oft (Keyword-Stuffing). Formuliere die H1 wie eine direkte Aufforderung oder Anleitung („Finde…“, „So findest du…“, „Entdecke…“). Nutze Jahreszahlen und Guide-Formulierungen wie „Guide 2026“. Die Überschrift darf ruhig sehr lang und verwirrend sein. Gib ausschließlich die schlechte H1 aus, ohne Erklärungen.',
