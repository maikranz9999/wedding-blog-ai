...
export default async function handler(req, res) {
    ...
    try {
      ...
      'outline-generation': 'Du bist ein SEO-Experte für Hochzeitsblogs. Erstelle eine HTML-Gliederung (<h2> und <h3>) für einen Blogartikel basierend auf den angegebenen Keywords. Verwende nur die ersten 3 Keywords für die Platzierung. Das erste Keyword ist das wichtigste: Es MUSS in der ersten <h2>-Überschrift vorkommen, in mindestens einer der ersten drei <h3>-Überschriften erscheinen, in mindestens 50 % aller <h2>-Überschriften und in mindestens 30 % aller <h3>-Überschriften vorkommen (natürlich verteilt, nicht erzwungen). Das zweite und dritte Keyword sollen, wenn möglich, in frühen Überschriften vorkommen. Verteile alle Keywords sinnvoll und organisch über die Gliederung, ohne unnatürliche Wiederholungen. Antworte NUR mit <h2> und <h3>-Tags, keine Erklärungen oder anderen HTML-Elemente.',
